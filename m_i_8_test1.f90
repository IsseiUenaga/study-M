...
call set_parameter(m,NN,tN,dt,domega0,I1,rho,W0,epsilon_a,epsilon_r_w,epsilon_R0,epsilon_delta_D,epsilon_tau_w, &
                   epsilon_W_vac,kappa,kappa_X,Re,Mm,arg_psi_vac,arg_psi,delta0,cap_delta_mode_0_p)

write(tmp1,'(1F5.1)') kappa
write(tmp2,'(1F4.2)') W0

filename1 = "result-m_i_8-main_kappa="//trim(adjustl(tmp1))//"_W0="//trim(adjustl(tmp2))//".dat"
filename2 = "result-m_i_8-sub_kappa="//trim(adjustl(tmp1))//"_W0="//trim(adjustl(tmp2))//".dat"
filename3 = "result-m_i_8-steady_kappa="//trim(adjustl(tmp1))//"_W0="//trim(adjustl(tmp2))//".dat"
...
do j = 0,5
   ...
   call initial_calculation(m,n,j,ite,t,dt,W_s0,domega_theta_s0,domega_z_s0,rho,kappa_X,Re,Mm,W0,omega0,domega0, &
                            epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0,epsilon_W_vac,arg_psi_vac, &
                            arg_psi,subf,cap_delta_mode_0_p)

   call calculation(m,n,i,ite,dt,dt1,t,tN,delta,delta0,delta1,W_s0,domega_theta_s0,domega_z_s0,rho,kappa_X, &
                    Re,Mm,I1,W0,omega0,epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0, &
                    epsilon_W_vac,arg_psi_vac,arg_psi,cap_delta_mode_0_p)
...
subroutine set_parameter(m,NN,tN,dt,domega0,I1,rho,W0,epsilon_a,epsilon_r_w,epsilon_R0,epsilon_delta_D,epsilon_tau_w, &
                         epsilon_W_vac,kappa,kappa_X,Re,Mm,arg_psi_vac,arg_psi,delta0,cap_delta_mode_0_p)
implicit none
...
real(8) :: omega_0_vec(0:50)
real(8),intent(in) :: domega0
real(8),intent(out) :: t
...
subroutine initial_calculation(m,n,j,ite,t,dt,W_s0,domega_theta_s0,domega_z_s0,rho,kappa_X,Re,Mm,W0,omega0,domega0, &
                               epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0,epsilon_W_vac,arg_psi_vac, &
                               arg_psi,subf,cap_delta_mode_0_p)
implicit none
...
real(8) :: t, dt
real(8) :: W_s0, domega_theta_s0, domega_z_s0
real(8) :: subf(1:12), omega0
real(8),intent(in) :: rho, kappa_X, Re, Mm, W0, domega0
...
call subfunctions(m,n,dt,W_s0,domega_theta_s0,domega_z_s0,W0,cap_delta_mode_0_p,omega0,epsilon_r_w, &
                  ...
                  arg_psi_vac,arg_psi,Re,Mm,rho,subf)

write(*,*) "TIME :", t, "ISLAND WIDTH :", W_s0, "ISLAND FREQUENCY :", subf(3)

!write(11,'(1X,4E20.10e2)') t, W_s0, domega_theta_s0, domega_z_s0
!write(12,'(1X,13E20.10e2)') t, subf(1:12)

end subroutine initial_calculation


subroutine calculation(m,n,i,ite,dt,dt1,t,tN,delta,delta0,delta1,W_s0,domega_theta_s0,domega_z_s0,rho,kappa_X, &
                       Re,Mm,I1,W0,omega0,epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0, &
                       epsilon_W_vac,arg_psi_vac,arg_psi,cap_delta_mode_0_p)
implicit none
integer :: m, n, ite, i
...
do i = 1,ite
   ...
   do
     call step_doubling(W_s0,domega_theta_s0,domega_z_s0,W_s1,domega_theta_s1,domega_z_s1,W_s2,domega_theta_s2,domega_z_s2, &
                        ...
                        arg_psi_vac,arg_psi,I1,cap_delta_mode_0_p,W0,omega0,m,n,i,dt1,dt2)
...
subroutine Runge_Kutta_method_of_4th_order(W_s0,domega_theta_s0,domega_z_s0,W_s,domega_theta_s,domega_z_s,rho,kappa_X,Re, &
                                           ...
                                           arg_psi_vac,arg_psi,RK,I1,dt,cap_delta_mode_0_p,W0,omega0,m,n)
implicit none
...
real(8) :: r_p_s, r_m_s, omega, delta_phi
...
delta_phi_vec(1) = delta_phi(arg_psi_vac,arg_psi)
...
delta_phi_vec(2) = delta_phi(arg_psi_vac,arg_psi)
...
delta_phi_vec(3) = delta_phi(arg_psi_vac,arg_psi)
...
delta_phi_vec(4) = delta_phi(arg_psi_vac,arg_psi)
...
subf(4) = delta_phi(arg_psi_vac,arg_psi)
...
real(8),intent(in) :: arg_psi_vac, arg_psi
real(8),intent(in) :: W0, omega0, cap_delta_mode_0_p
real(8),intent(in) :: epsilon_delta_D, epsilon_tau_w, epsilon_r_w
real(8),intent(in) :: epsilon_a, epsilon_R0, epsilon_W_vac
...
call Runge_Kutta_method_of_4th_order(W_s0,domega_theta_s0,domega_z_s0,W_s1,domega_theta_s1,domega_z_s1,rho,kappa_X,Re, &
                                     Mm,epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0,epsilon_W_vac, &
                                     arg_psi_vac,arg_psi,RK,I1,dt1,cap_delta_mode_0_p,W0,omega0,m,n)

dt2 = dt1/2.0d0
call Runge_Kutta_method_of_4th_order(W_s0,domega_theta_s0,domega_z_s0,W_s,domega_theta_s,domega_z_s,rho,kappa_X,Re, &
                                     Mm,epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0,epsilon_W_vac, &
                                     arg_psi_vac,arg_psi,RK,I1,dt2,cap_delta_mode_0_p,W0,omega0,m,n)
W_s0 = W_s
...
!   write(13,'(1X,2E20.10e2)') omega0, subf(3), W_s0/W0
...
function delta_phi(arg_psi_vac,arg_psi)
real(8),intent(in) :: arg_psi_vac, arg_psi
real(8) :: delta_phi
delta_phi = 0.0d0 +arg_psi_vac -arg_psi
