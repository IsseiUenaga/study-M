...
real(8) :: arg_psi_vac, arg_psi, cap_omega0, delta_phi0
...
do j = 2,2
   ...
   call initial_calculation(pi,m,n,j,ite,t,dt,W_s0,domega_theta_s0,domega_z_s0,rho,kappa_X,Re,Mm,W0,omega0,deWv, &
                            ...
                            arg_psi,subf,cap_delta_mode_0_p,cap_omega0,delta_phi0)
   ...
   call calculation(pi,m,n,i,ite,dt,dt1,t,tN,delta,delta0,delta1,W_s0,domega_theta_s0,domega_z_s0,rho,kappa_X, &
                    ...
                    epsilon_W_vac,arg_psi_vac,arg_psi,cap_delta_mode_0_p,delta_phi0,subf,cap_omega0)
...
subroutine initial_conditions(j,t,W_s,domega_theta_s,domega_z_s,epsilon_W_vac,cap_omega0,deWv)
implicit none
integer,intent(in) :: j
...
real(8) :: t, dt, pi
real(8) :: W_s0, domega_theta_s0, domega_z_s0
real(8) :: subf(1:12), epsilon_W_vac, cap_omega0, delta_phi0
...
call initial_conditions(j,t,W_s0,domega_theta_s0,domega_z_s0,epsilon_W_vac,cap_omega0,deWv)
...
call subfunctions(m,n,dt,W_s0,domega_theta_s0,domega_z_s0,W0,cap_delta_mode_0_p,omega0,epsilon_r_w, &
                  ...
                  arg_psi_vac,arg_psi,Re,Mm,rho,cap_omega0,subf)
...
real(8) :: arg_psi_vac, arg_psi, cap_omega0, cap_omega, delta_phi0, omega
real(8) :: cap_delta_mode_0_p
real(8) :: t_vec(i), subf(1:12), omega_vec(0:ite), RK(1:4,1:3)
logical :: switch1
...
do i = 1,ite
   ...
   do
     call step_doubling(W_s0,domega_theta_s0,domega_z_s0,W_s1,domega_theta_s1,domega_z_s1,W_s2,domega_theta_s2,domega_z_s2, &
                        ...
                        arg_psi_vac,arg_psi,I1,cap_delta_mode_0_p,W0,omega0,cap_omega0,m,n,i,dt1,dt2,subf)
   ...
   t = t +dt1
   cap_omega = cap_omega0 +(omega(domega_theta_s1,domega_z_s1,omega0,m,n) +subf(3))*dt1/2.0d0

   if(t >= tN) exit

   call subfunctions(m,n,dt,W_s1,domega_theta_s1,domega_z_s1,W0,cap_delta_mode_0_p,omega0,epsilon_r_w, &
                     epsilon_tau_w,epsilon_delta_D,epsilon_a,epsilon_R0,epsilon_W_vac,kappa_X, &
                     arg_psi_vac,arg_psi,Re,Mm,rho,cap_omega,subf)

   W_s0 = W_s1
   domega_theta_s0 = domega_theta_s1
   domega_z_s0 = domega_z_s1
   omega_vec(i) = subf(3)
!   write(14,'(1X,6E20.10e3)') t, domega_theta_s0, domega_z_s0, subf(3), cap_omega, subf(4)/pi
   ...
   if((tN-10.0d0<t .and. t<tN) .or. abs(omega_vec(i))<1.0d-10) then
       call steady(m,n,i,ite,dt,dt1,t,tN,delta,delta0,delta1,W_s0,domega_theta_s0,domega_z_s0,rho,kappa_X,Re,Mm,I1,W0, &
                   ...
                   arg_psi,cap_delta_mode_0_p,delta_phi0)
       exit
   end if
...
subroutine Runge_Kutta_method_of_4th_order(W_s0,domega_theta_s0,domega_z_s0,W_s,domega_theta_s,domega_z_s,rho,kappa_X,Re, &
                                           ...
                                           arg_psi_vac,arg_psi,RK,I1,dt,cap_delta_mode_0_p,W0,omega0,cap_omega0,m,n)
implicit none
...
real(8),intent(in) :: arg_psi_vac, arg_psi, cap_omega0
...
real(8),intent(in) :: arg_psi_vac, arg_psi, cap_omega
...
real(8) :: W_s, domega_theta_s, domega_z_s
real(8) :: W_s0, domega_theta_s0, domega_z_s0
real(8) :: cap_omega0, cap_omega, delta_phi0, delta_phi, omega
real(8) :: RK(1:4,1:3)
...
call Runge_Kutta_method_of_4th_order(W_s0,domega_theta_s0,domega_z_s0,W_s1,domega_theta_s1,domega_z_s1,rho,kappa_X,Re, &
                                     Mm,epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0,epsilon_W_vac, &
                                     arg_psi_vac,arg_psi,RK,I1,dt1,cap_delta_mode_0_p,W0,omega0,cap_omega0,m,n)

dt2 = dt1/2.0d0
call Runge_Kutta_method_of_4th_order(W_s0,domega_theta_s0,domega_z_s0,W_s,domega_theta_s,domega_z_s,rho,kappa_X,Re, &
                                     Mm,epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0,epsilon_W_vac, &
                                     arg_psi_vac,arg_psi,RK,I1,dt2,cap_delta_mode_0_p,W0,omega0,cap_omega0,m,n)
W_s0 = W_s
...
call Runge_Kutta_method_of_4th_order(W_s0,domega_theta_s0,domega_z_s0,W_s2,domega_theta_s2,domega_z_s2,rho,kappa_X,Re, &
                                     Mm,epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0,epsilon_W_vac, &
                                     arg_psi_vac,arg_psi,RK,I1,dt2,cap_delta_mode_0_p,W0,omega0,cap_omega,m,n)
...
real(8) :: cap_omega0, cap_omega, delta_phi0, omega
...
do k = i+1,i+100
   ...
   dt1 = dt
   cap_omega0 = arg_psi_vac -delta_phi0
