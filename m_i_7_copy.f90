...
do j = 0,100
   ...
   call initial_calculation(m,n,j,ite,t,dt,W_s0,domega_theta_s0,domega_z_s0,rho,kappa_X,Re,Mm,W0,omega0,domega0, &
                            epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0,subf,cap_delta_mode_0_p)
...
subroutine set_parameter(m,NN,tN,dt,domega0,I1,rho,W0,beta,epsilon_a,epsilon_r_w,epsilon_R0,epsilon_delta_D, &
                         epsilon_tau_w,kappa_X,Re,Mm,delta0,cap_delta_mode_0_p)
implicit none
...
call subfunctions(m,n,dt,W_s0,domega_theta_s0,domega_z_s0,W0,cap_delta_mode_0_p,omega0,epsilon_r_w, &
                  epsilon_tau_w,epsilon_delta_D,epsilon_a,kappa_X,epsilon_R0,Re,Mm,rho,subf)
...
do i = 1,ite
   ...
   do
     call step_doubling(W_s0,domega_theta_s0,domega_z_s0,W_s1,domega_theta_s1,domega_z_s1,W_s2,domega_theta_s2,domega_z_s2, &
                        rho,kappa_X,Re,Mm,epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0,I1, &
                        cap_delta_mode_0_p,W0,omega0,m,n,i,dt1,dt2)
     ...
     if(delta1/dt1 > delta0) then
        delta = (delta0/(2.0d0*(delta1/dt1)))**(0.25d0)
        if(delta <= 0.1d0) then
           dt1 = 0.1d0*dt1
...
RK(4,1) = f_1(cap_delta_mode_p_vec(4),cap_delta_wall_p_vec(4),I1)
