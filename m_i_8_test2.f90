...
call set_parameter(m,NN,tN,dt,deWv,I1,rho,W0,epsilon_a,epsilon_r_w,epsilon_R0,epsilon_delta_D,epsilon_tau_w, &
...
do j = 0,50
   ...
   call initial_calculation(m,n,j,ite,t,dt,W_s0,domega_theta_s0,domega_z_s0,rho,kappa_X,Re,Mm,W0,omega0,deWv, &
...
subroutine set_parameter(m,NN,tN,dt,deWv,I1,rho,W0,epsilon_a,epsilon_r_w,epsilon_R0,epsilon_delta_D,epsilon_tau_w, &
                         epsilon_W_vac,kappa,kappa_X,Re,Mm,arg_psi_vac,arg_psi,delta0,omega0,cap_delta_mode_0_p)
implicit none
...
subroutine initial_conditions(j,t,W_s,domega_theta_s,domega_z_s,epsilon_W_vac,deWv)
implicit none
integer,intent(in) :: j
real(8),intent(in) :: deWv
real(8),intent(out) :: t
real(8),intent(out) :: W_s, domega_theta_s, domega_z_s, epsilon_W_vac
...
subroutine initial_calculation(m,n,j,ite,t,dt,W_s0,domega_theta_s0,domega_z_s0,rho,kappa_X,Re,Mm,W0,omega0,deWv, &
                               epsilon_delta_D,epsilon_tau_w,epsilon_r_w,epsilon_a,epsilon_R0,epsilon_W_vac,arg_psi_vac, &
                               arg_psi,subf,cap_delta_mode_0_p)
implicit none
...
real(8) :: t, dt
real(8) :: W_s0, domega_theta_s0, domega_z_s0
real(8) :: subf(1:12), epsilon_W_vac
...
call initial_conditions(j,t,W_s0,domega_theta_s0,domega_z_s0,epsilon_W_vac,deWv)
...
do i = 1,ite
   ...
   omega_vec(i) = subf(3)
   write(14,'(1X,4E20.10e3)') t, domega_theta_s0, domega_z_s0, subf(3)
